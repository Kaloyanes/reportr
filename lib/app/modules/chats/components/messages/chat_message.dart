...
class ChatMessage extends StatefulWidget {
  const ChatMessage({super.key, required this.message, required this.ownMessage, required this.doc});
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.only(
                    bottomLeft: widget.ownMessage ? const Radius.circular(40) : const Radius.circular(10),
