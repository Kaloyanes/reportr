...
class LocationPickerController extends GetxController {
  ...
  final cameraPosition = const CameraPosition(target: LatLng(42.510578, 27.461014)).obs;
  ...
  Future<void> centerCamera() async {
    await mapController.animateCamera(CameraUpdate.newLatLngZoom(await GeoService().getLocation(), 16));
  }

  void updatePosition(CameraPosition position) => cameraPosition.value = position;
