...
import 'package:reportr/app/modules/chats/chat_messages/controllers/location_picker_controller.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: Row(
        ...
        children: [
          FloatingActionButton(onPressed: () => controller.centerCamera(), child: const Icon(Icons.navigation_rounded)),
          const SizedBox(
            width: 10,
          ),
          FloatingActionButton(
              heroTag: "sendButton", onPressed: () => controller.sendLocation(), child: const Icon(Icons.send)),
        ],
      ),
    );
  }
