                ...
                () => Column(
                  children: [
                    CheckboxListTile.adaptive(
                      ...
                      onChanged: (value) => controller.isOrganization.value = value ?? false,
                      selected: controller.isOrganization.value,
                      title: const Text("Регистрирай като организация?"),
                    ),
                    AnimatedSize(
                      duration: 700.ms,
                      curve: Curves.easeOutQuint,
                      alignment: Alignment.topCenter,
                      child: controller.isOrganization.value
                          ? Column(
